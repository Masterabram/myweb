...
/*
 * @author Abraham Ogol
 * @facebbok https://www.facebook.com/abramogol
 * @twitter https://twitter.com/ogolAbraham
 */
...
try {
  ...
  if ($keyword <> "" ) {
    $sql = "SELECT * FROM tbl_masenoict WHERE 1 AND "
    ...
    $sql = "SELECT * FROM tbl_masenoict WHERE 1 ORDER BY name ";
    $stmt = $DB->prepare($sql);
  }
  ...
  <div class="panel panel-primary">
    ...
    <div class="panel-body">
      ...
      <div class="col-lg-12" style="padding-left: 0; padding-right: 0;" >
        ...
        <div class="pull-right" ><a href="../links/masenoict.php"><button class="btn btn-success"><span class="glyphicon glyphicon-user"></span> Add New Member</button></a></div>
      </div>
